                    ...
                    <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor:'rgba(0,0,0,.5)'}}>
                        <TouchableOpacity onPress={() => {this.state.started ? this.tryAgain() : this.startGame()}}>
                            <Text style={{fontSize: 32, color: 'white', fontWeight: '500'}}>
                                {this.state.started ? 'Tentar Novamente' : 'Iniciar'}</Text>
                        </TouchableOpacity>
                    </View>
                </Modal>
            )
        ...
        return (
            <View style={{flex: 1, justifyContent: 'space-around'}}>
                <View style={{paddingTop: 40, justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <Text style={{paddingTop: 10, fontSize: 30, color: '#fff'}}> Pontos: {this.state.score}</Text>
                </View>
                ...
                <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                    ...
                    <View style={{marginLeft: 20, alignItems: 'center', padding: 20 }}>
